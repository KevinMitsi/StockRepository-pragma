...
public class HandlerExceptionController {
    ...
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingCategoryException(RuntimeException e){
    ...
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingBrandException(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponseDto(e.getClass().getCanonicalName(), e.getMessage(), HttpStatus.BAD_REQUEST));
    }

    @ExceptionHandler(ItemException.class)
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingItemException(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponseDto(e.getClass().getCanonicalName(), e.getMessage(), HttpStatus.BAD_REQUEST));
    }

    @ExceptionHandler(IllegalArgumentException.class)
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingIllegalArgument(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponseDto(e.getClass().getCanonicalName(), e.getMessage(), HttpStatus.BAD_REQUEST));
    }
    @ExceptionHandler(IncreaseItemStockException.class)
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingIncreaseItemStock(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponseDto(e.getClass().getCanonicalName(), e.getMessage(), HttpStatus.BAD_REQUEST));
    }
    ...
    public ResponseEntity<ExceptionResponseDto> inCaseThrowingNoSuchElementException(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponseDto(e.getClass().getCanonicalName(), e.getMessage(), HttpStatus.BAD_REQUEST));
    }
